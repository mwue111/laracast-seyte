    ...
    <section class="px-6 px-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 p-6 rounded-xl border border-gray-200">
            ...
            <form method="POST" action="/register" class="mt-10">
                ...
                <div class="mb-6">
                    <label class="block mb-2 uppercase font-bold text-xs text-gray-700" for="username">Nombre de usuario/a:</label>
                ...
                <div class="mb-6">
                    <label class="block mb-2 uppercase font-bold text-xs text-gray-700" for="password">Contraseña:</label>
                ...
                <div class="mb-6 text-center">
                    <button type="submit" class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500">Enviar</button>
                </div>
